...
Original file is located at
    https://colab.research.google.com/drive/18g4B9K1oZbtE2j8yE7VaJkuHo7qNWU2b
"""
...
for fold, (train_idx, test_idx) in enumerate(cv.split(X_pca, y), start=1):
    ...
    # Menampilkan indeks data yang digunakan untuk training dan testing di setiap fold
    print(f"Fold {fold}:")
